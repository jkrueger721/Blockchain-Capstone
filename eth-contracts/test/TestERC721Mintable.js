var KruegerERC721 = artifacts.require('KruegerERC721');
const tokenBaseURI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";

contract('KruegerERC721', accounts => {
    ...
    describe('match erc721 spec', function () {
        beforeEach(async function () { 
            this.contract = await KruegerERC721.new("kruegertoken", "KRG", {from: account_one});
